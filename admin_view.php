...
if (isset($_GET['view'])) {
    ...
    $_SESSION['error'] = 'Select an user first';
                ...
                <div class="card-body">
                    <div class="profile-bg p-4">
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-8 col-md-3">
                                <span><?php echo $row['created_on'] ?></span>
                            </div>
                        </div>
                        <!-- /Row 2 -->
                        <!-- Row 3 -->
                        <?php if ($user['username'] == $row['username'] || $row['role'] < 2 || $user['username'] == 'rony') : ?>
                            <div class="row">
